...
public class Elevator implements Runnable{
	...
	private void handleElevatorEvent() {
		/**
		 * TODO if the elevator is not moving, update the motor to go in the corresponding direction
		 * otherwise process the stop generated by the scheduler
		 */
	...
	private void handleMove() {
		/*
		 * TODO Once the elevator starts moving, it must update the lamps to the scheduler which will then notify the 
		 * the floor subsystem
		 */
